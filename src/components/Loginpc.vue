<template>
    <div>
        <div>
            ...
            <mt-field label="密码" :state="loginForm.password.length>5?'success':'error'" placeholder="请输入用户名" v-model="loginForm.password"></mt-field>
            <mt-button type="primary" @click="submitForm('loginForm')">primary</mt-button>
        </div>
        <!-- <el-row>
